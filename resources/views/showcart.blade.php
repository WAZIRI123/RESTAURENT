...
<div id="top" class="container w-50">
 
    <table class="table table-light  d-block justify-content-center align-items-center">
        ...
        <form action="{{url('orderconfirm')}}" method="post">
            ...
            <tr>
                ...
                <td><input type="text" name="quantity[]" value="{{$data->quantity}}" hidden="">
                    {{$data->quantity}}</td>
                <td><img src="/foodimage/{{$data->image}} " width=100 height=100 alt="" srcset=""></td>
          
            @endforeach
            @foreach($data2 as $data2)
         
            <td style=""><a href="{{url('/removeshowcart',$data2->id)}}" class="btn btn-warning"> Remove</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
...
<div align="center" style="padding:10px; align">
<label>Phone</label>
